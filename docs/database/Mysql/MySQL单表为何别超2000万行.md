---
description: 本文深入解析MySQL InnoDB存储引擎中 B+树索引与16KB数据页的结构原理，揭示业界常说的“单表数据量别超过2000万”的由来。通过树高、扇出值、磁盘I/O等关键因素，说明当数据量突破阈值后为何会出现性能断崖，并延伸到B树对比、单页大小设计原因，以及中英文字符串索引优化方案。
title: MySQL单表为何别超2000万行？——B+树与16KB数据页的性能真相
tag:
  - MySQL
sidebar: true
comment: true
...
![image-20250915232143262](../../工作/image/image-20250915232143262.png)
...
![image-20250915234642341](../../工作/image/image-20250915234642341.png)
...
![image-20250915234707145](../../工作/image/image-20250915234707145.png)
...
![image-20250915234725348](../../工作/image/image-20250915234725348.png)
...
![image-20250915234740164](../../工作/image/image-20250915234740164.png)
...
![image-20250915235028230](../../工作/image/image-20250915235028230.png)
...
![image-20250915235200544](../../工作/image/image-20250915235200544.png)
...
![image-20250915235310913](../../工作/image/image-20250915235310913.png)
