---
description: 分享10个 Claude Code 隐藏命令和快捷键（/btw、/rewind、/insights、/model
  opusplan、/simplify、/branch、/loop、/remote-control、/export 及实用快捷键），帮助开发者把 Claude Code 从"聊天
  AI"进化为全能开发副驾。这些技巧涵盖上下文管理、代码回退、自动审查、任务循环、远程控制、对话导出等高频场景。
...
![image-20260324223817415](..\image\image-20260324223817415.png)
...
![image-20260324223930162](..\image\image-20260324223930162.png)

就以前你可能跟Claude说"比如试试这种写法"，改完发现不行，只能整段对话一起回退，连你之前的讨论也没了。

而现在，打/rewind会弹出菜单让你选，是只回退代码还是只回退对话。

比如我现在我开发了一个功能，我觉得不好，想撤销，我就可以先打/rewind，然后把这个会话里面的历史拽出来。![image-20260324223942840](..\image\image-20260324223942840.png)

然后我就点击之前的会话。

就会弹出一个菜单。![image-20260324223953220](..\image\image-20260324223953220.png)
...
![image-20260324224110672](..\image\image-20260324224110672.png)

其实，就是Claude Code在反向观察你。

你直接打这个命令以后，他就会给你一份做好的本地HTML网页。

![image-20260324224123197](..\image\image-20260324224123197.png)

做的非常详细。

![image-20260324230001296](..\image\image-20260324230001296.png)

还有翻车现场。

![image-20260324230050758](..\image\image-20260324230050758.png)
...
![image-20260324224517569](..\image\image-20260324224517569.png)

而且这是正儿八经的隐藏命令。

你直接/model切换模型，可是没有这个模式的。

![image-20260324224530872](..\image\image-20260324224530872.png)
...
![image-20260324224638019](..\image\image-20260324224638019.png)

但是我记得好像之前1月就开源过了，只不过是2月底才集成到Claude code里面去的。

/simplify可以理解成一个三合一的代码审查工具，本质上其实是个Skills。

你输入/simplify之后，Claude Code会同时启动三个平行的Agent，分别从代码复用、代码质量、运行效率三个角度审查你的改动。![image-20260324224650011](..\image\image-20260324224650011.png)

然后汇总结果告诉你哪些地方可以优化，我是因为之前跑过了，所以比较干净。

![image-20260324224719723](..\image\image-20260324224719723.png)
...
![image-20260324224753794](..\image\image-20260324224753794.png)
...
![image-20260324224906386](..\image\image-20260324224906386.png)

用法是/loop后面跟时间间隔和你要它做的事情。

比如/loop 5m 检查一下部署状态，它会每五分钟帮你跑一次，不用你自己盯着，默认间隔是10分钟。

![image-20260324224918071](..\image\image-20260324224918071.png)
...
如果你希望一直运行下去，Claude给到的方式，是使用桌面版。![image-20260324224950410](..\image\image-20260324224950410.png)

## 八、 /remote-control

这个功能是今年2月底出的，我觉得是Claude Code比较实用的功能之一。

你在终端里打/rc，或者打完整的/remote-control，它会生成一个URL。![image-20260324225011885](..\image\image-20260324225011885.png)
...
![image-20260324225034317](..\image\image-20260324225034317.png)
...
![image-20260324225043059](..\image\image-20260324225043059.png)
...
**Ctrl+J，Mac用户也可以Option+回车，都可以直接实现换行。**![image-20260324225233851](..\image\image-20260324225233851.png)

Ctrl+R，可以搜索你之前输入过的所有prompt历史。

![image-20260324225254501](..\image\image-20260324225254501.png)
...
![image-20260324225335835](..\image\image-20260324225335835.png)
